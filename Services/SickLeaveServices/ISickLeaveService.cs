...
public interface ISickLeaveService
{
    ...
    Task<ServiceResponse<List<object>>> GetAllCustomSickLeave();
    ...
    Task<ServiceResponse<GetSickLeaveDto>> UpdateSickLeaveSehaty(UpdateSickLeaveSehatyDto updateSickLeave);
